...
Ensure to update <span style="color:red">username</span>, <span style="color:red">password</span>, <span style="color:red">n</span> and <database> according to your setup
