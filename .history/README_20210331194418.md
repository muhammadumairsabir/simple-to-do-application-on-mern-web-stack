...
- In <span style="color:red">Todo</span> folder open the package.json<span style="color:red">package.json</span> file. Change the highlighted part of the below screenshot and replace with the code below.
