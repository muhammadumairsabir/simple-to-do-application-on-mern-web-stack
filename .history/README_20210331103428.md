...
Now we need to update the <span style="color:red">index.js</span> to reflect the use of <span style="color:red">username</span> so that Node.js can connect to the database.