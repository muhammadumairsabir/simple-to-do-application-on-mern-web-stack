...
For each task, we need to create <span style="color:red">routes</span> that will define various endpoints that the To-do app will depend on. So let us create a folder routes