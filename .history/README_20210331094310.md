...
In the index.js<span style="color:red">vim api.js</span> file, we specified process.env to access environment variables, but we have not yet created this file. So we need to do that now.
