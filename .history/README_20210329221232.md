...
**Note**: The command above installs both <span style="color:red">nodejs</span>. and <span style="color:red">npm</span>. [NPM](https://www.npmjs.com/) is a package manager for Node like apt for Ubuntu, it is used to install Node modules & packages and to manage dependency conflicts.
