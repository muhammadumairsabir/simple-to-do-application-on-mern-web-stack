...
In this project, I will implement a web solution based on MERN stack on a Linux server. I will be deploying an application that is used to create ‘Todo’ lists by implementing the steps below: