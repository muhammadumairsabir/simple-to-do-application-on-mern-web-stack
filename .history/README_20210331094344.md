...
In the <span style="color:red">index.js</span> file, we specified <span style="color:red">vim api.js</span> to access environment variables, but we have not yet created this file. So we need to do that now.
