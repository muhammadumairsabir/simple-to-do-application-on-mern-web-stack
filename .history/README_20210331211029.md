...
Inside ‘components’ directory create three files <span style="color:red">Input.js</span>, <span style="color:red">ListTodo.js</span> and <span style="color:red">src</span>
