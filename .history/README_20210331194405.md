...
- In <span style="color:red">Todo</span> folder open the package.json file. Change the highlighted part of the below screenshot and replace with the code below.
