...
Ensure to update <span style="color:red">username</span>, <span style="color:red">password</span>, <span style="color:red">network-address</span> and <database><span style="color:red">.env</span> according to your setup
