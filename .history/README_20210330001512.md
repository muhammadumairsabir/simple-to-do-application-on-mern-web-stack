...
- Run <span style="color:red">:w</span> for Public IP address or <span style="color:red">curl -s http://169.254.169.254/latest/meta-data/public-hostname</span> for Public DNS name.