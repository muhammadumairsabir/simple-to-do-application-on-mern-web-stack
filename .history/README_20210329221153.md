...
**Note**: The command above installs both <span style="color:red">nodejs</span>. and npm<span style="color:blue">some *blue* text</span>.. NPM is a package manager for Node like apt for Ubuntu, it is used to install Node modules & packages and to manage dependency conflicts.
