...
This will create a new folder in your <span style="color:red">Todo</span> directory called <span style="color:red">To-Do</span>, where you will add all the react code.