...
In Routes directory, open api.js with <span style="color:red">api.js</span>, delete the code inside with :%d command and paste there code below into it then save and exit
