...
**Note**: The command above installs both nodejs<span style="color:red">some *blue* text</span>. and npm. NPM is a package manager for Node like apt for Ubuntu, it is used to install Node modules & packages and to manage dependency conflicts.
